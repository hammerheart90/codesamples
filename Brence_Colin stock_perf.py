#from pandas.io import data, web  # import package for fetching data from web
import pandas #import pandas packages for data reader to fetch data from websites such as Yahoo finance
import pandas_datareader.data as web
from pandas_datareader import data, wb
import datetime
import matplotlib.pyplot as plt # matplot lib to display and plot graphs of stock price performance over time
...
stockpicks.head() #plot performance of stock portfolio
stockpicks.plot(grid=True)
